...
# modify the circle function so that it allows the colour of the circle to be specified and defaults to red if color not given.
# you may want to review the previous lectures about parameters and default values.
#
